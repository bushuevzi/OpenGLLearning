...
namespace OpenGLLearning
{
    ...
    public class Game : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            // Привязываем буфер который создали.
            // OpenGL использует одно глобальное состояние, таким образом после того как мы это привязываем буфер
            ...
            // Первый аргумент это тип буфера который мы привязываем, в нашем случае VBO -- это ArrayBuffer
            ...
            // Делаем привязку массива вершин к сцене
            ...
            // В конечном итоге, мы снова привязываем VBO, при этом так же автоматически привязывается VAO и наоборот
            GL.BindBuffer(BufferTarget.ArrayBuffer, _vertexBufferObject);
